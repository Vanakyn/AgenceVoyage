...
?>
	...
	<?php if( get_theme_mod('adventure_trekking_camp_theme_loader','') != ''){ ?>
		<div class="preloader">
			<div class="load">
			  <hr/><hr/><hr/><hr/>
			</div>
		...
		<div class="menu-header py-2">
			<div class="container-fluid">
				<div class="menu-header-inner">
					<div class="row">
						<div class="col-lg-2 col-md-3 col-sm-3 mb-2 mb-md-0">
							<div class="logo py-3 py-lg-0">
					            ...
					            <?php endif; ?>
				              	<?php $adventure_trekking_camp_blog_info = get_bloginfo( 'name' ); ?>
					                ...
					                ?>
					                <p class="site-description mb-0"><?php echo esc_html($adventure_trekking_camp_description); ?></p>
				              	<?php endif; ?>
						    </div>
						</div>
