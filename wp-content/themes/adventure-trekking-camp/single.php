...
<?php
	$adventure_trekking_camp_post_sidebar = get_theme_mod( 'adventure_trekking_camp_single_post_sidebar' );
	if ( 'false' == $adventure_trekking_camp_post_sidebar ) {
		...
		<div class="content-area entry-content">
			<div id="main" class="site-main" role="main">
		       	<div class="row m-0">
					...
					<?php if ( 'false' != $adventure_trekking_camp_post_sidebar ) {?>
