...
<?php }else if($adventure_trekking_camp_post_option == '5_column'){ ?>
			...
			<div class="postbox smallpostimage p-2 mb-3">
	        	...
	        	<div class="overlay pt-2 text-center">
	        		<div class="date-box mb-2">
	        			<?php if( get_theme_mod('adventure_trekking_camp_date',true) != ''){ ?>
	        				<span class="mr-2"><i class="far fa-calendar-alt mr-2"></i><?php the_time( get_option( 'date_format' ) ); ?></span>
	        			<?php } ?>
	        			<?php if( get_theme_mod('adventure_trekking_camp_admin',true) != ''){ ?>
	        			...
	        			<?php }?>
	        			<?php if( get_theme_mod('adventure_trekking_camp_comment',true) != ''){ ?>
