...
== Changelog ==
    ...
    1.1.1 - September 12, 2022
    * Fixed: Error page latest posts image issue.
    * Fixed: TGMPA warning in PHP 8 is fixed.

    1.1.0 - July 18, 2022
    * Added: feature to load google font locally

    1.0.9 - May 31, 2022
    * Fix: Submenu in secondary menu toggle issue is fixed.
    * Fix: WooCommerce product review tab design issue is fixed.
    * Update: Fontawesome is updated to 6.1.1 for latest icons.

    1.0.8 - February 10, 2022
    * Recommended AffiliateX plugin
     
    1.0.7 - November 11, 2021
	  * Fixed design issue in instagram section

    1.0.6 - October 29, 2021
      * Fixed responsive menu issue for dropdown
      * Fixed menu design fixes

    1.0.5 - October 8, 2021
      * Fixed navigation menu issue for downward arrow
      * Fixed newsletter button alignment
      * Updated google fonts

    1.0.4 - May 27, 2021
      * Modified div structure of search
